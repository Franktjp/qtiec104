 ...
 * NOTE: The cp24time2a abandons the 4th to 7th bytes of cp56time2a. So the size of
 * cp24time2a is 3 bytes.
 */
struct cp24time2a {
    uint16_t mesc;   // milliseconds
    uint8_t min : 6; // minutes
...
struct apdu {
    ...
    union {
        ...
        struct {
            /**
             * @brief ioa - information object address. We think the default size of ioa is 3 bytes.
             */
            uint16_t ioa16;
            uint8_t ioa8;
