...
public:
    ...
    static const uint32_t M_SP_TA_1 = 2;  // single-point information with time tag(cp24time2a)
    ...
    static const uint32_t M_BO_TA_1 = 8;  // bitstring of 32 bits with time tag(cp24time2a)
    ...
    static const uint32_t C_RC_TA_1 = 60; // regulating step command with time tag
...
protected:
    ...
    // TODO: 是的，显示数据
    virtual void dataIndication(struct iec_obj* /* obj */, unsigned int /* numpoints */) = 0;
