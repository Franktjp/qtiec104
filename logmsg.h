...
{
public:
    // TODO: set log level(日志等级), such as trace跟踪, debug调试, info通知, warning警告, error错误, fatal致命错误 and so on.
...
private:
    ...
    bool isLogable;
    bool isRegTime;
    unsigned int level;	// 显示级别0=全部，1打开，逐步显示更多信息 display level 0=all, 1 an on, display more information progressively
};
